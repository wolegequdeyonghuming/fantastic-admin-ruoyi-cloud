...
import { uploadAvatar } from '@/api/modules/system/user'
...
const { error, success } = useFaToast()
...
async function uploadImg() {
  cropper.value.getCropBlob(async (data: any) => {
    ...
    appAccountStore.setAvatar(options.img)
    success('修改成功')
    visible.value = false
  })
}
...
function closeDialog() {
  options.img = appAccountStore.avatar
